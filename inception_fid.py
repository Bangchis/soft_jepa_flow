"""Vendored from kvfrans/jax-fid-parallel (Apache-2.0 License).

Pure JAX/Flax InceptionV3 for FID computation.
Original: https://github.com/kvfrans/jax-fid-parallel/blob/main/fid.py

API:
    get_fid_network() -> apply_fn  (pmap'd, input [-1,1] 299x299x3)
